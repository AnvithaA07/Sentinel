...
function Landing() {
  ...
  return (
    <div
      id="land"
      className="landing-container min-h-screen flex flex-col items-center justify-center"
    >
      ...
      {showContent && (
        <>
          ...
          >
            <form
              className="card-content flex flex-col gap-4 items-center"
          ...
          <div className="mt-6">
            {breachData.length > 0
                  ...
                  <Card key={index} className="mx-auto my-4 p-4 bg-gray-900">
                    {inputType === "email" ? (
                      <>
                        ...
                        <p className="text-center">
                          <strong>Records:</strong> {item.records}
                        </p>
                      </>
                    ) : inputType === "domain" ? (
                      status && (
                        <>
                          ...
                          <p className="font-bold text-center text">
                            Records Breached : {item.records}
                          </p>
                      ...
                      inputType === "password" && (
                        <>
                          ...
                          <p className="text-center">
                            Password Hash: {item.hash}
                          </p>
                          <p className="text-center">
                            Records Found: {item.count}
                          </p>
                        </>
                      )
                    )}
              ...
              : submitted && (
                  <p className="text-white text-center mb-4 text-5xl font-bold">
                    You're safe!
                  </p>
                )}
          </div>
